...
// GG has modified this script from the original supplied by Amazon
...
namespace AWSSDK.Examples
{
    ...
    {
        public string IdentityPoolId = "ap-south-1:3b6f6e23-aa2c-472f-8604-cca691d98ef5";
        ...
        public string S3BucketName = "ar-assetbundle";
        public string SampleFileName = "benz"; 
        [SerializeField] string assetBundleFolder = null;  // GG added
        ...
        public string AssetBundlePath { get; set; } // GG added
                ...
                if (response.ResponseStream != null)
                {
                    using (BinaryReader bReader = new BinaryReader(response.ResponseStream))
                    {
                        ...
                        if (!Directory.Exists(assetBundleDir))
                        {
                            ...
                            AssetBundlePath = Path.Combine(assetBundleDir, SampleFileName);
                        }
                        else
                        {
                            AssetBundlePath = Path.Combine(assetBundleDir, SampleFileName);                            
                        ...
                        File.WriteAllBytes(AssetBundlePath, buffer);
                    }
                }
                else
                {
                    Debug.Log("GetObject error");
                }
